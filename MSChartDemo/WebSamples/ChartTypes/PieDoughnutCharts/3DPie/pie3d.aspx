			...
			<table class="sampleTable">
				<tr>
					<td width="412" class="tdchart">
						<asp:CHART id="Chart1" runat="server" Palette="BrightPastel" BackColor="WhiteSmoke" Height="296px" Width="412px" BorderDashStyle="Solid" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2" BorderColor="26, 59, 105" ImageLocation="~/TempImages/chart_0_21.png">
							<titles>
							...
							<series>
								<asp:Series Name="Default" ChartType="Pie" BorderColor="180, 26, 59, 105" Color="220, 65, 140, 240" ChartArea="ChartArea1" Legend="Default"></asp:Series>
							</series>
							<chartareas>
					...
					<td valign="top">
						<table class="controls" cellpadding="4">
							...
							<tr>
								<td class="label" style="height: 42px">Show as 3D:</td>
								<td style="height: 42px"><asp:checkbox id="CheckboxShow3D" runat="server" AutoPostBack="True" Text=""></asp:checkbox></td>
							</tr>
						</table>
					</td>
				</tr>
