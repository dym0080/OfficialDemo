			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart">
					    ...
					    <asp:chart id="Chart1" runat="server" Height="296px" Width="412px" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)" ImageType="Png" BorderDashStyle="Solid" palette="Pastel" BackGradientStyle="TopBottom" BorderWidth="2" backcolor="#D3DFF0" BorderColor="26, 59, 105">
							<titles>
